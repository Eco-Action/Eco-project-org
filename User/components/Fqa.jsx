...
const FAQItem = ({ question, answer }) => {
  ...
  return (
    <div className="mb-4 last:mb-0">
      ...
      {isOpen && (
        <div className="mt-1 py-3 px-5 bg-white rounded-lg shadow-inner">
...
const FAQ = () => {
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-green-100 via-green-50 to-blue-100">
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-center mb-8">
          <Leaf className="w-12 h-12 text-green-500 mx-auto mb-2" />
          <h2 className="text-3xl font-bold text-green-800 mb-2">Frequently Asked Questions</h2>
          <p className="text-base text-green-600">Find answers to common questions about our mission and initiatives</p>
        </div>
        <div className="bg-white bg-opacity-70 backdrop-filter backdrop-blur-lg rounded-2xl shadow-xl p-6">
