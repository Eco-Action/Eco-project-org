...
//             />
//             <button type="submit" className="mt-2 bg-green-600 text-white rounded px-4 py-2">Submit</button>
//           </form>
//         </div>
//       )}
//     </div>
...
//     post.user.username.toLowerCase().includes(searchQuery.toLowerCase()) // Filter by username
//   );
