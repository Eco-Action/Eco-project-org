...
// import { Loader, Search, Calendar, Clock, Star } from 'lucide-react';
...
//   console.log("ikk" + token)

//   const handleChallengeClick = (challengeId) => {
//     const isAuthorized = Cookies.get('token');
//     console.log("ikk" + isAuthorized)
//     if (!isAuthorized) {
...
//       <header className="bg-gradient-to-r from-green-600 to-green-400 text-white py-8 px-4 sm:px-6 lg:px-8 shadow-lg">
//         <motion.h1
...
//             <Search className="w-5 h-5 text-green-500 ml-4" />
//             <input
//               type="text"
...
//             transition={{ duration: 0.5 }}
//           >
//             {/* <h2 className="text-3xl font-bold mb-8 text-green-800">Challenges</h2> */}
//             <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
//               {currentChallenges.map((challenge, index) => (
//                 <motion.div
//                   key={challenge._id}
//                   className="bg-white overflow-hidden shadow-lg rounded-lg hover:shadow-2xl cursor-pointer transition-all duration-300"
//                   initial={{ opacity: 0, y: 50 }}
//                   animate={{ opacity: 1, y: 0 }}
...
//                   </div>
//                   <div className="p-6">
//                     <h3 className="text-2xl font-bold mb-2 text-green-600 line-clamp-2">{challenge.title}</h3>
...
//                       </span>
//                       <span className="text-sm px-2 py-1 bg-green-100 text-green-800 rounded-full">{challenge.impactType}</span>
//                     </div>
...
//             className="mx-2 bg-green-600 text-white px-4 py-2 rounded disabled:opacity-50 transition-colors duration-300 hover:bg-green-700"
//           >
//             Previous
//           </button>
...
const ChallengeList = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-green-50 to-blue-50 min-h-screen">
      <header className="bg-gradient-to-r from-green-600 to-blue-500 text-white py-12 px-4 sm:px-6 lg:px-8 shadow-lg">
        <motion.h1
      ...
      <main className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
              ...
              {currentChallenges.map((challenge, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-6">
                      <h3 className={`text-2xl font-bold mb-2 ${isCompletedOrApproved ? 'text-gray-600' : 'text-green-600'} line-clamp-2`}>
                        {challenge.title}
                      </h3>
                      <p className="text-gray-600 mb-4 line-clamp-3">{challenge.description}</p>
                      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex justify-center mt-12">
          <motion.button
            ...
            onClick={() => handlePageChange(currentPage - 1)}
            disabled={currentPage === 1}
            className="mx-2 bg-green-600 text-white px-6 py-3 rounded-md disabled:opacity-50 transition-colors duration-300 hover:bg-green-700 flex items-center"
          >
